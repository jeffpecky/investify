<script lang="ts">
    ...
    import { linkTransform, formatDateExt, cn } from '$lib/utils';
            ...
            {#each filteredDocuments as doc (doc.id)}
                <div class="group flex flex-col bg-card rounded-xl border shadow-sm hover:shadow-md transition-all overflow-hidden h-full">
                    ...
                    <div class="flex flex-col p-4 grow">
                        ...
                        <div class="text-muted-foreground text-sm line-clamp-3 mb-4 grow">
                            {@html doc.description}
                        </div>

                        <!-- Footer part -->
                        <div class="mt-auto pt-3 border-t flex items-center justify-between text-xs text-muted-foreground w-full">
