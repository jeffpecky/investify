	...
	<div class="mx-auto max-w-7xl px-6 lg:px-8">
		<div class="grid grid-cols-1 gap-16 lg:grid-cols-2">
			...
			<div use:animate={{ type: 'fadeRight', delay: 0.2 }}>
				...
				{#if form?.success}
					<div class="rounded-lg bg-green-50 p-6 text-green-700 border border-green-200">
				...
				{:else}
					...
					>
						...
						<div>
							<label class="block text-xs text-muted-foreground mb-2" for="interest">Area of Interest</label>
							<select
								name="interest"
